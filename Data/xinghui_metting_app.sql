...
-- ----------------------------
INSERT INTO `tzht_admin` VALUES ('1', 'admin123', '1eea36fbd4f4919251e3192dce2da380', '', '', '1', '221.216.126.15', '1523547294', '282');
...
CREATE TABLE `tzht_chatgroup` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=51 DEFAULT CHARSET=utf8 COMMENT='群组表';
...
INSERT INTO `tzht_chatgroup` VALUES ('11', '45', null, '开发部群组', '', '个人群组公告', '7c0afc35-9ee0-4e68-b76f-9b063dd8e627', '1518051477');
...
INSERT INTO `tzht_chatgroup` VALUES ('25', '45', '46,40,,,44,,34,88,87,,,,,43,39,,,50,47,,48,62,81', '2018人工智能', '', '未设置', '8fe9f100-25cc-4627-baa5-4740341e5912', '1522831007');
INSERT INTO `tzht_chatgroup` VALUES ('26', '41', '61,53', '幸会小团队', '', '未设置', '281b89dd-91dc-4835-9f18-b2a909864bb3', '1523268469');
INSERT INTO `tzht_chatgroup` VALUES ('27', '45', '47,46', '2018群组', '', '未设置', 'c17ef09c-4fa0-47d0-aa21-e4e6aa0b75f9', '1523583462');
...
INSERT INTO `tzht_chatgroup` VALUES ('50', '45', '87,81,44', '小小猪', '', '未设置', '82984e13-2593-42ff-94b7-eda78d4e0f2b', '1524046006');
...
CREATE TABLE `tzht_chatgroup_bull` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=54 DEFAULT CHARSET=utf8 COMMENT='群组公告表';
...
INSERT INTO `tzht_chatgroup_member` VALUES ('49', '45', '81');
...
INSERT INTO `tzht_chatgroup_member` VALUES ('50', '45', '81');
...
INSERT INTO `tzht_chatgroup_member` VALUES ('10', '41', '50');
INSERT INTO `tzht_chatgroup_member` VALUES ('10', '41', '49');
...
INSERT INTO `tzht_chatgroup_member` VALUES ('17', '41', '50');
INSERT INTO `tzht_chatgroup_member` VALUES ('17', '41', '49');
...
INSERT INTO `tzht_chatgroup_member` VALUES ('19', '45', '81');
...
INSERT INTO `tzht_chatgroup_member` VALUES ('25', '45', '50');
INSERT INTO `tzht_chatgroup_member` VALUES ('25', '45', '47');
INSERT INTO `tzht_chatgroup_member` VALUES ('25', '45', '48');
INSERT INTO `tzht_chatgroup_member` VALUES ('25', '45', '62');
INSERT INTO `tzht_chatgroup_member` VALUES ('25', '45', '81');
...
CREATE TABLE `tzht_collection` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=66 DEFAULT CHARSET=utf8 COMMENT='会员收藏表';
...
CREATE TABLE `tzht_conference` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=165 DEFAULT CHARSET=utf8 COMMENT='会议表';
...
INSERT INTO `tzht_conference` VALUES ('155', '百度会展开幕19', '2018-04-10 19:21:35', '2018-04-12 00:00:00', '2018-04-10 18:00:00', '北京北京市石景山区', '景阳宏昌大厦', '[\"\"]', '北京同舟鸿图文化创意有限公司', '郑伟', '13552832050', '', '4', '2', '1523359352', '15', '0', '1', '', '', '', '<p>北京同舟鸿图文化创意有限公司</p>', '0', '1,2,4', '0');
INSERT INTO `tzht_conference` VALUES ('156', '百度会展开幕21', '2018-04-12 21:37:26', '2018-04-20 00:00:00', '2018-04-12 00:00:00', '北京北京市石景山区', '景阳宏昌大厦', '[\"\\/Uploads\\/product\\/2018-04-12\\/5acf612c0becb.jpg\"]', '北京同舟鸿图文化创意有限公司', '郑伟', '17600898102', '/Uploads/file/20180417/1523955339/jBPM4工作流应用开发指南_01.pdf###/Uploads/file/20180417/1523955363/产品简介.doc###/Uploads/file/20180417/1523955417/产品功能.xlsx###/Uploads/file/20180417/1523955513/展示PPT（初版）.ppt###', '4', '2', '1523540276', '15', '0', '0', '', '', '', '', '0', '1,2', '15');
INSERT INTO `tzht_conference` VALUES ('158', 'GMIC 2018 北京 全球移动互联网大会（AI生万物）', '2018-04-16 09:43:13', '2018-04-18 00:00:00', '2018-04-17 13:00:00', '北京北京市朝阳区', '北京市朝阳区天辰东路7号', '[\"\\/Uploads\\/product\\/2018-04-16\\/5ad3ff9e04e21.png\"]', '北京中网深蓝技术有限公司', '李洪亮', '18810356923', '', '34', '3', '1523843004', '1523', '1', '1', '', '', '', '<h3 class=\"first_title\" style=\"padding: 0px; margin: 0px 0px 10px; font-family: 微软雅黑; box-sizing: border-box; list-style: none; max-width: 768px; text-align: center; color: rgb(51, 51, 51); font-size: 18px; white-space: normal; background-color: rgb(255, 255, 255);\">-会议内容-</h3><p style=\"padding: 0px; font-family: 微软雅黑; box-sizing: border-box; list-style: none; max-width: 768px; width: 727.991px; color: rgb(102, 102, 102); line-height: 24px; white-space: normal; background-color: rgb(255, 255, 255); margin-top: 0px !important; margin-bottom: 0px !important; font-size: 14px !important;\"><strong style=\"padding: 0px; margin: 0px; box-sizing: border-box; list-style: none; max-width: 768px;\">亲爱的吉米客们（GMICers）：</strong></p><p style=\"padding: 0px; font-family: 微软雅黑; box-sizing: border-box; list-style: none; max-width: 768px; width: 727.991px; color: rgb(102, 102, 102); line-height: 24px; white-space: normal; background-color: rgb(255, 255, 255); margin-top: 0px !important; margin-bottom: 0px !important; font-size: 14px !important;\">GMIC北京2017大会5万人参与的景象犹在眼前，GMIC北京2018又拉开了启动大幕。2018年4月26日-28日，我们又将相会在国家会议中心，共同见证中国<a href=\"https://m.huodongjia.com/tag/437/\" style=\"padding: 0px; margin: 0px; box-sizing: border-box; list-style: none; max-width: 768px; text-decoration-line: none;\">互联网</a>和<a href=\"https://m.huodongjia.com/tag/1192/\" style=\"padding: 0px; margin: 0px; box-sizing: border-box; list-style: none; max-width: 768px; text-decoration-line: none;\">科技</a>领域的进步与发展。</p><p style=\"padding: 0px; font-family: 微软雅黑; box-sizing: border-box; list-style: none; max-width: 768px; width: 727.991px; color: rgb(102, 102, 102); line-height: 24px; white-space: normal; background-color: rgb(255, 255, 255); margin-top: 0px !important; margin-bottom: 0px !important; font-size: 14px !important;\">站在AlphaGo Zero、量子技术、<a href=\"https://m.huodongjia.com/tag/17374/\" style=\"padding: 0px; margin: 0px; box-sizing: border-box; list-style: none; max-width: 768px; text-decoration-line: none;\">区块链</a>等各种新技术持续爆发的时代关口，我们有必要回顾一下中国互联网与科技的<a href=\"https://m.huodongjia.com/tag/926/\" style=\"padding: 0px; margin: 0px; box-sizing: border-box; list-style: none; max-width: 768px; text-decoration-line: none;\">历史</a>，从时代的角度来剖析中国互联网与科技的未来：</p><p style=\"padding: 0px; font-family: 微软雅黑; box-sizing: border-box; list-style: none; max-width: 768px; width: 727.991px; color: rgb(102, 102, 102); line-height: 24px; white-space: normal; background-color: rgb(255, 255, 255); margin-top: 0px !important; margin-bottom: 0px !important; font-size: 14px !important;\"><strong style=\"padding: 0px; margin: 0px; box-sizing: border-box; list-style: none; max-width: 768px;\">1998年-2007年 中国PC互联网的黄金十年</strong></p><p style=\"padding: 0px; font-family: 微软雅黑; box-sizing: border-box; list-style: none; max-width: 768px; width: 727.991px; color: rgb(102, 102, 102); line-height: 24px; white-space: normal; background-color: rgb(255, 255, 255); margin-top: 0px !important; margin-bottom: 0px !important; font-size: 14px !important;\">1998年，是中国互联网企业值得纪念的一年，这一年，腾讯、新浪、京东、搜狐都纷纷成立，奠定了中国互联网在全球市场的地位，直至今日，这些即将迎来20年诞辰的企业仍屹立在行业之巅。以网易、新浪、搜、腾讯为代表的“四大门户”共同拉开了中国互联网高速发展的帷幕，深刻影响了中国的<a href=\"https://m.huodongjia.com/tag/909/\" style=\"padding: 0px; margin: 0px; box-sizing: border-box; list-style: none; max-width: 768px; text-decoration-line: none;\">经济</a>、<a href=\"https://m.huodongjia.com/tag/1742/\" style=\"padding: 0px; margin: 0px; box-sizing: border-box; list-style: none; max-width: 768px; text-decoration-line: none;\">社会</a>的发展。</p><p style=\"padding: 0px; font-family: 微软雅黑; box-sizing: border-box; list-style: none; max-width: 768px; width: 727.991px; color: rgb(102, 102, 102); line-height: 24px; white-space: normal; background-color: rgb(255, 255, 255); margin-top: 0px !important; margin-bottom: 0px !important; font-size: 14px !important;\"><strong style=\"padding: 0px; margin: 0px; box-sizing: border-box; list-style: none; max-width: 768px;\">2008年-2017年 中国<a href=\"https://m.huodongjia.com/tag/966/\" style=\"padding: 0px; margin: 0px; box-sizing: border-box; list-style: none; max-width: 768px; text-decoration-line: none;\">移动互联网</a>的黄金十年</strong></p><p style=\"padding: 0px; font-family: 微软雅黑; box-sizing: border-box; list-style: none; max-width: 768px; width: 727.991px; color: rgb(102, 102, 102); line-height: 24px; white-space: normal; background-color: rgb(255, 255, 255); margin-top: 0px !important; margin-bottom: 0px !important; font-size: 14px !important;\">2008年，iPhone的入华标志着中国互联网进入到了移动互联网时代，微博、小米、微信、美团等明向企业纷纷崛起，成为大众的生活中不可缺少的重要工具。而随着移动互联网的崛起，在市场、资本等力量的共同作用下，中国互联网的发展也超越了欧美等传统科技强国，实现了从“copy to China”到“copy from China”的逆转，成就了新的全球经济奇迹。</p><p><br/></p>', '0', '8', '8');
INSERT INTO `tzht_conference` VALUES ('159', 'WOT 2018 – 全球软件与运维技术峰会', '2018-04-16 10:36:34', '2018-04-18 00:00:00', '2018-04-17 10:00:00', '北京北京市西城区', ' 西城区宣武门外大街18号', '[\"\\/Uploads\\/product\\/2018-04-16\\/5ad40b635ccff.jpg\"]', '北京中网深蓝技术有限公司', '李洪亮', '18810356923', '', '34', '3', '1523846211', '1253', '1', '1', '', '', '', '<h3 class=\"first_title\" style=\"padding: 0px; margin: 0px 0px 10px; font-family: 微软雅黑; box-sizing: border-box; list-style: none; max-width: 768px; text-align: center; color: rgb(51, 51, 51); font-size: 18px; white-space: normal; background-color: rgb(255, 255, 255);\">-会议内容-</h3><p style=\"padding: 0px; font-family: 微软雅黑; box-sizing: border-box; list-style: none; max-width: 768px; width: 727.991px; color: rgb(102, 102, 102); line-height: 24px; white-space: normal; background-color: rgb(255, 255, 255); margin-top: 0px !important; margin-bottom: 0px !important; font-size: 14px !important;\"><img alt=\"WOT 2018 – 全球软件与运维技术峰会\" src=\"/Uploads/ueditor/image/20180416/1523846173.png\"/></p><p style=\"padding: 0px; font-family: 微软雅黑; box-sizing: border-box; list-style: none; max-width: 768px; width: 727.991px; color: rgb(102, 102, 102); line-height: 24px; white-space: normal; background-color: rgb(255, 255, 255); margin-top: 0px !important; margin-bottom: 0px !important; font-size: 14px !important;\">01.内容重组</p><p style=\"padding: 0px; font-family: 微软雅黑; box-sizing: border-box; list-style: none; max-width: 768px; width: 727.991px; color: rgb(102, 102, 102); line-height: 24px; white-space: normal; background-color: rgb(255, 255, 255); margin-top: 0px !important; margin-bottom: 0px !important; font-size: 14px !important;\">打造核心热点技术与<a href=\"https://m.huodongjia.com/tag/2347/\" style=\"padding: 0px; margin: 0px; box-sizing: border-box; list-style: none; max-width: 768px; text-decoration-line: none;\">科学</a>技术内容，始终坚持与全球技术同步。</p><p style=\"padding: 0px; font-family: 微软雅黑; box-sizing: border-box; list-style: none; max-width: 768px; width: 727.991px; color: rgb(102, 102, 102); line-height: 24px; white-space: normal; background-color: rgb(255, 255, 255); margin-top: 0px !important; margin-bottom: 0px !important; font-size: 14px !important;\">02.阵容突破</p><p style=\"padding: 0px; font-family: 微软雅黑; box-sizing: border-box; list-style: none; max-width: 768px; width: 727.991px; color: rgb(102, 102, 102); line-height: 24px; white-space: normal; background-color: rgb(255, 255, 255); margin-top: 0px !important; margin-bottom: 0px !important; font-size: 14px !important;\">4位大会主席坐镇，12位联合出品人认证，60位大咖讲师汇聚。</p><p style=\"padding: 0px; font-family: 微软雅黑; box-sizing: border-box; list-style: none; max-width: 768px; width: 727.991px; color: rgb(102, 102, 102); line-height: 24px; white-space: normal; background-color: rgb(255, 255, 255); margin-top: 0px !important; margin-bottom: 0px !important; font-size: 14px !important;\">03.情怀蜕变</p><p style=\"padding: 0px; font-family: 微软雅黑; box-sizing: border-box; list-style: none; max-width: 768px; width: 727.991px; color: rgb(102, 102, 102); line-height: 24px; white-space: normal; background-color: rgb(255, 255, 255); margin-top: 0px !important; margin-bottom: 0px !important; font-size: 14px !important;\">7年磨一剑，集聚历届明星讲师和高端用户，全面升级英雄汇party。</p><p style=\"padding: 0px; font-family: 微软雅黑; box-sizing: border-box; list-style: none; max-width: 768px; width: 727.991px; color: rgb(102, 102, 102); line-height: 24px; white-space: normal; background-color: rgb(255, 255, 255); margin-top: 0px !important; margin-bottom: 0px !important; font-size: 14px !important;\">04.玩法创新</p><p style=\"padding: 0px; font-family: 微软雅黑; box-sizing: border-box; list-style: none; max-width: 768px; width: 727.991px; color: rgb(102, 102, 102); line-height: 24px; white-space: normal; background-color: rgb(255, 255, 255); margin-top: 0px !important; margin-bottom: 0px !important; font-size: 14px !important;\">四大创新玩法，覆盖网络巡展、圆桌对话、高端闭门、英雄汇晚宴。</p><p style=\"padding: 0px; font-family: 微软雅黑; box-sizing: border-box; list-style: none; max-width: 768px; width: 727.991px; color: rgb(102, 102, 102); line-height: 24px; white-space: normal; background-color: rgb(255, 255, 255); margin-top: 0px !important; margin-bottom: 0px !important; font-size: 14px !important;\">05.传播升级</p><p style=\"padding: 0px; font-family: 微软雅黑; box-sizing: border-box; list-style: none; max-width: 768px; width: 727.991px; color: rgb(102, 102, 102); line-height: 24px; white-space: normal; background-color: rgb(255, 255, 255); margin-top: 0px !important; margin-bottom: 0px !important; font-size: 14px !important;\">覆盖网络媒体、平面媒体、<a href=\"https://m.huodongjia.com/tag/2660/\" style=\"padding: 0px; margin: 0px; box-sizing: border-box; list-style: none; max-width: 768px; text-decoration-line: none;\">自媒体</a>、以及广电媒体和国际媒体等40家。</p><p><br/></p>', '0', '9', '2');
INSERT INTO `tzht_conference` VALUES ('160', '第九届中国数据库技术大会（DTCC 2018）', '2018-04-16 10:38:31', '2018-04-19 00:00:00', '2018-04-17 19:00:00', '北京北京市朝阳区', '北京市朝阳区北辰东路8号', '[\"\\/Uploads\\/product\\/2018-04-16\\/5ad40c8e51540.jpg\"]', '北京中网深蓝技术有限公司', '李洪亮', '18810356923', '', '34', '3', '1523846327', '120', '1', '0', '', '', '', '<h3 class=\"first_title\" style=\"padding: 0px; margin: 0px 0px 10px; font-family: 微软雅黑; box-sizing: border-box; list-style: none; max-width: 768px; text-align: center; color: rgb(51, 51, 51); font-size: 18px; white-space: normal; background-color: rgb(255, 255, 255);\">-会议内容-</h3><p style=\"padding: 0px; font-family: 微软雅黑; box-sizing: border-box; list-style: none; max-width: 768px; width: 727.991px; color: rgb(102, 102, 102); line-height: 24px; white-space: normal; background-color: rgb(255, 255, 255); margin-top: 0px !important; margin-bottom: 0px !important; font-size: 14px !important;\">中国<a href=\"https://m.huodongjia.com/tag/4679/\" style=\"padding: 0px; margin: 0px; box-sizing: border-box; list-style: none; max-width: 768px; text-decoration-line: none;\">数据库</a>技术大会（简称DTCC）是国内数据库及<a href=\"https://m.huodongjia.com/tag/969/\" style=\"padding: 0px; margin: 0px; box-sizing: border-box; list-style: none; max-width: 768px; text-decoration-line: none;\">大数据</a>领域规模最大、最受欢迎的技术交流盛会，每年一届。自2010年以来，迄今已成功举办了八届，累计参与人次达到20000+。DTCC每年都将邀请百余位行业专家，就热点技术话题进行分享，为数据库人群、大数据从业人员、广大<a href=\"https://m.huodongjia.com/tag/437/\" style=\"padding: 0px; margin: 0px; box-sizing: border-box; list-style: none; max-width: 768px; text-decoration-line: none;\">互联网</a>人士及行业相关人士提供最具价值的交流平台。 2018年5月10-12日，第九届中国数据库技术大会（DTCC2018）将如约而至。本届大会以“数领先机•智赢未来”为主题，设定2大主会场及20个技术专场，邀请来自国内外互联网、<a href=\"https://m.huodongjia.com/tag/807/\" style=\"padding: 0px; margin: 0px; box-sizing: border-box; list-style: none; max-width: 768px; text-decoration-line: none;\">金融</a>、教育等行业百余位技术专家，共同探讨Oracle、MySQL、NoSQL、大数据、机器学习、<a href=\"https://m.huodongjia.com/tag/17374/\" style=\"padding: 0px; margin: 0px; box-sizing: border-box; list-style: none; max-width: 768px; text-decoration-line: none;\">区块链</a>、数据可视化等领域的前瞻性热点话题与技术。</p><p style=\"padding: 0px; font-family: 微软雅黑; box-sizing: border-box; list-style: none; max-width: 768px; width: 727.991px; color: rgb(102, 102, 102); line-height: 24px; white-space: normal; background-color: rgb(255, 255, 255); margin-top: 0px !important; margin-bottom: 0px !important; font-size: 14px !important;\">&nbsp;</p><p style=\"padding: 0px; font-family: 微软雅黑; box-sizing: border-box; list-style: none; max-width: 768px; width: 727.991px; color: rgb(102, 102, 102); line-height: 24px; white-space: normal; background-color: rgb(255, 255, 255); margin-top: 0px !important; margin-bottom: 0px !important; font-size: 14px !important;\"><img alt=\"第九届中国数据库技术大会（DTCC 2018）\" src=\"/Uploads/ueditor/image/20180416/1523846302.png\"/></p><p><br/></p>', '0', '8', '4');
INSERT INTO `tzht_conference` VALUES ('161', '公开-测试会议-1', '2018-04-17 10:42:00', '2018-04-19 04:42:00', '2018-04-18 05:42:00', '河北省保定市安国市', '5856', '[\"\\/Uploads\\/Conference\\/20180417\\/1523934282\\/90599c89278411674bfa858a158458af.jpg\"]', '北京中网深蓝技术有限公司', '张伟', '18810356923', 'null###', '34', '6', '1523933158', '0', '1', '0', null, null, null, '会议简洁', '0', '', '15');
INSERT INTO `tzht_conference` VALUES ('162', '内部会议-测试会议-1', '2018-04-17 05:07:00', '2018-04-19 11:07:00', '2018-04-18 11:07:00', '上海市上海市浦东新区', '滨江大道2727号', 'null', '北京中网深蓝技术有限公司', 'Jake', '17600898105', 'null###', '34', '5', '1523934580', '0', '1', '0', null, null, null, '会议简洁', '1', '', '15');
INSERT INTO `tzht_conference` VALUES ('164', '内', '2018-04-18 15:44:00', '2018-05-03 18:44:00', '2018-05-03 03:44:00', '北京市北京市石景山区', '22', 'null', '中国会议服务咨询公司', '刘', '63942568', 'null###', '62', '1', '1524037548', '0', '0', '0', null, null, null, '', '1', '', '3');
...
INSERT INTO `tzht_conference_audit` VALUES ('116', '41', '5');
INSERT INTO `tzht_conference_audit` VALUES ('116', '43', '5');
...
INSERT INTO `tzht_conference_audit` VALUES ('116', '40', '5');
INSERT INTO `tzht_conference_audit` VALUES ('147', '40', '5');
INSERT INTO `tzht_conference_audit` VALUES ('146', '61', '1');
INSERT INTO `tzht_conference_audit` VALUES ('116', '61', '5');
...
INSERT INTO `tzht_conference_audit` VALUES ('150', '41', '5');
INSERT INTO `tzht_conference_audit` VALUES ('151', '45', '2');
INSERT INTO `tzht_conference_audit` VALUES ('151', '46', '1');
INSERT INTO `tzht_conference_audit` VALUES ('148', '46', '1');
INSERT INTO `tzht_conference_audit` VALUES ('161', '87', '4');
INSERT INTO `tzht_conference_audit` VALUES ('162', '87', '4');
INSERT INTO `tzht_conference_audit` VALUES ('156', '43', '4');
INSERT INTO `tzht_conference_audit` VALUES ('148', '34', '1');
INSERT INTO `tzht_conference_audit` VALUES ('156', '34', '1');
INSERT INTO `tzht_conference_audit` VALUES ('146', '34', '3');
INSERT INTO `tzht_conference_audit` VALUES ('146', '46', '3');
...
INSERT INTO `tzht_conference_auditlist` VALUES ('116', '41', '5');
INSERT INTO `tzht_conference_auditlist` VALUES ('116', '43', '5');
...
INSERT INTO `tzht_conference_auditlist` VALUES ('116', '40', '5');
INSERT INTO `tzht_conference_auditlist` VALUES ('147', '40', '5');
INSERT INTO `tzht_conference_auditlist` VALUES ('146', '61', '1');
INSERT INTO `tzht_conference_auditlist` VALUES ('116', '61', '5');
...
INSERT INTO `tzht_conference_auditlist` VALUES ('150', '41', '5');
INSERT INTO `tzht_conference_auditlist` VALUES ('151', '45', '2');
INSERT INTO `tzht_conference_auditlist` VALUES ('151', '46', '1');
INSERT INTO `tzht_conference_auditlist` VALUES ('148', '46', '1');
INSERT INTO `tzht_conference_auditlist` VALUES ('161', '87', '4');
INSERT INTO `tzht_conference_auditlist` VALUES ('162', '87', '4');
INSERT INTO `tzht_conference_auditlist` VALUES ('156', '43', '4');
INSERT INTO `tzht_conference_auditlist` VALUES ('148', '34', '1');
INSERT INTO `tzht_conference_auditlist` VALUES ('156', '34', '1');
INSERT INTO `tzht_conference_auditlist` VALUES ('146', '34', '3');
INSERT INTO `tzht_conference_auditlist` VALUES ('146', '46', '3');
...
INSERT INTO `tzht_conference_down` VALUES ('43', '153', '20170706APP数据库表结构.xlsx', '1523538592');
...
INSERT INTO `tzht_conference_focus` VALUES ('41', '43', '1', '0', '刘为国');
...
INSERT INTO `tzht_conference_focus` VALUES ('43', '34', '0', '0', '中网');
...
INSERT INTO `tzht_conference_focus` VALUES ('43', '41', '1', '0', '王总');
...
INSERT INTO `tzht_conference_focus` VALUES ('34', '40', '0', '0', '');
...
INSERT INTO `tzht_conference_focus` VALUES ('41', '61', '1', '0', '移动号');
INSERT INTO `tzht_conference_focus` VALUES ('45', '62', '0', '0', '企业伙伴');
INSERT INTO `tzht_conference_focus` VALUES ('45', '44', '0', '0', '陈江');
INSERT INTO `tzht_conference_focus` VALUES ('88', '34', '1', '0', '');
INSERT INTO `tzht_conference_focus` VALUES ('45', '46', '0', '0', '');
...
INSERT INTO `tzht_conference_focus` VALUES ('45', '88', '0', '0', '');
INSERT INTO `tzht_conference_focus` VALUES ('45', '82', '0', '0', '');
INSERT INTO `tzht_conference_focus` VALUES ('45', '72', '0', '0', '');
INSERT INTO `tzht_conference_focus` VALUES ('45', '50', '0', '0', '');
INSERT INTO `tzht_conference_focus` VALUES ('45', '48', '0', '0', '');
INSERT INTO `tzht_conference_focus` VALUES ('45', '43', '1', '0', '');
INSERT INTO `tzht_conference_focus` VALUES ('45', '39', '0', '0', '');
INSERT INTO `tzht_conference_focus` VALUES ('45', '81', '0', '0', '');
INSERT INTO `tzht_conference_focus` VALUES ('62', '4', '1', '0', '');
INSERT INTO `tzht_conference_focus` VALUES ('62', '41', '1', '0', '');
INSERT INTO `tzht_conference_focus` VALUES ('45', '87', '0', '0', '');
INSERT INTO `tzht_conference_focus` VALUES ('34', '45', '1', '0', '');
INSERT INTO `tzht_conference_focus` VALUES ('34', '47', '1', '0', '');
INSERT INTO `tzht_conference_focus` VALUES ('34', '87', '1', '0', '张伟');
INSERT INTO `tzht_conference_focus` VALUES ('47', '53', '0', '0', '');
INSERT INTO `tzht_conference_focus` VALUES ('34', '4', '0', '0', '');
INSERT INTO `tzht_conference_focus` VALUES ('44', '43', '0', '0', '');
...
INSERT INTO `tzht_conference_sign` VALUES ('161', '87');
INSERT INTO `tzht_conference_sign` VALUES ('162', '87');
INSERT INTO `tzht_conference_sign` VALUES ('156', '43');
...
CREATE TABLE `tzht_jgpushperson` (
  ...
  `addtime` int(11) NOT NULL COMMENT '添加时间',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=205 DEFAULT CHARSET=utf8 COMMENT='极光推送个人消息表';
...
INSERT INTO `tzht_jgpushperson` VALUES ('201', '151', '45', '及时推送', '消息机器', '0', '1523840917');
...
CREATE TABLE `tzht_log` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=2078 DEFAULT CHARSET=utf8 COMMENT='登录日志表';
...
CREATE TABLE `tzht_product_stats` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=21 DEFAULT CHARSET=utf8 COMMENT='企业产品点击统计表';
...
CREATE TABLE `tzht_rongcloudim` (
  ...
  `addtime` int(11) NOT NULL DEFAULT '0' COMMENT '添加时间',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=16 DEFAULT CHARSET=utf8 COMMENT='融云讨论组表';
...
CREATE TABLE `tzht_signjgpush` (
  ...
  `addtime` int(11) NOT NULL COMMENT '添加时间',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=82 DEFAULT CHARSET=utf8 COMMENT='签到推送消息表';
...
INSERT INTO `tzht_user` VALUES ('45', '', '', 'tzhtlhl2018', '9D37FF541601DE56D952276F07082FBB0AE78B16', '18810356923', '/./Uploads/Avatar/2018-03-19/5aaf356898e1a.jpeg', '金融保险', '北京同舟鸿图文化创意有限公司', '互联网频道', '北京市北京市朝阳区', '想這有', '', '0', '', '1', '1', '1518003074', '0', '127.0.0.1', '', 'w40L+qNEyn0S1t2gMU1eVmLgkQ3O+7PFPxqmhyeRWfhohMKSEQoTXuhzU4ia7gFbaSNcrwcfN0k=', '', '', '签名', '/Home/Index/usercode/id/45.html', '0', '李洪亮', '0', '45_xinghuiapp', '1', '', '睡醒的兔子', '0');
...
-- ----------------------------
INSERT INTO `tzht_user_part` VALUES ('4', '1,2', '156');
