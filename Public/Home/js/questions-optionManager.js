...
OptionTemplate = {
	...
	get: function(type){
		...
		switch(type){
			case 'radio': //单选项
					return '<div class="option-item radio_option"> <input name="-" type="radio" /> <div> <input type="text" class="form-control" placeholder="请输入选项文本" /> <img class="option-del" src="/Public/Home/images/btn-del.png" title="删除该选项"> </div> </div>';

			case 'checkbox': //多选项
					return '<div class="option-item checkbox_option"> <input type="checkbox" /> <div> <input type="text" class="form-control" placeholder="请输入选项文本" /> <img class="option-del" src="/Public/Home/images/btn-del.png" title="删除该选项"> </div> </div>';

			case 'text': //简答项
					return '<div class="option-item text_option"> <textarea class="form-control"> </textarea> <img class="option-del" src="/Public/Home/images/btn-del.png" title="删除该选项"> </div>';
